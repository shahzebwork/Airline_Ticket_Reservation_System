...
$con=mysqli_connect("localhost","root","","muhammad_shahzeb_4009");
...
<center><img src='images/PIA1.jpg' class='img-thumbnail' width='00px' style='height:0px;'></center>";
                   ...
                   <?php
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      {                  
                        ...
                        echo "<center><img src='images/PIA1.jpg' class='img-thumbnail' width='180px' style='height:180px;'></center>";
                        echo"<div>";
                      }
                   ?>
                        </td>
